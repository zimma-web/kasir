                        ...
                        <tbody>
                            @forelse ($pelanggan as $member)
                                <tr class="border-b dark:border-gray-700">
                                    <td class="px-4 py-3">{{ $member->nama_pelanggan }}</td>
                                    <td class="px-4 py-3">{{ $member->alamat }}</td>
                                    <td class="px-4 py-3">{{ $member->nomor_telepon }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a href="{{ route('pelanggan.edit', $member->id) }}"
                                        ...
                                        <form action="{{ route('pelanggan.destroy', $member->id) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-3 text-center">Tidak ada data member</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
