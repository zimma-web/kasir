                    ...
                    <form method="POST" action="{{ route('pelanggan.update', $pelanggan->id) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="nama_pelanggan" name="nama_pelanggan"
                                ...
                                placeholder="Masukkan nama member" value="{{ old('nama_pelanggan', $pelanggan->nama_pelanggan) }}" required>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="alamat" name="alamat" rows="3"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Masukkan alamat member" required>{{ old('alamat', $pelanggan->alamat) }}</textarea>
                            @error('alamat')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="nomor_telepon" name="nomor_telepon"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Masukkan nomor telepon" value="{{ old('nomor_telepon', $pelanggan->nomor_telepon) }}"
                                maxlength="13"
                                pattern="[0-9]*"
