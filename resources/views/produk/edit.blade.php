                    ...
                    <div class="w-full">
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div class="w-full">
                                    <label for="gambar"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-4">Foto Produk</label>
                                    ...
                                    @if(isset($produk) && $produk->gambar)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $produk->gambar) }}" alt="{{ $produk->nama_produk }}" class="w-32 h-32 object-cover rounded">
                                        </div>
                                    @endif
                                </div>
                            </div>
